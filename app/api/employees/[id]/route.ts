...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    if (data.firstName !== undefined && data.firstName !== currentEmployee.firstName)
      updateData.firstName = data.firstName
    if (data.lastName !== undefined && data.lastName !== currentEmployee.lastName) updateData.lastName = data.lastName
    if (data.email !== undefined && data.email !== currentEmployee.email) updateData.email = data.email
    if (data.phoneNumber !== undefined && data.phoneNumber !== currentEmployee.phoneNumber)
      updateData.phoneNumber = data.phoneNumber

    // Address
    if (data.street !== undefined && data.street !== currentEmployee.street) updateData.street = data.street
    if (data.city !== undefined && data.city !== currentEmployee.city) updateData.city = data.city
    if (data.state !== undefined && data.state !== currentEmployee.state) updateData.state = data.state
    if (data.postalCode !== undefined && data.postalCode !== currentEmployee.postalCode)
      updateData.postalCode = data.postalCode
    if (data.country !== undefined && data.country !== currentEmployee.country) updateData.country = data.country

    // Emergency contact
    if (data.emergencyName !== undefined && data.emergencyName !== currentEmployee.emergencyName)
    ...
    if (data.emergencyPhoneNumber !== undefined && data.emergencyPhoneNumber !== currentEmployee.emergencyPhoneNumber)
      updateData.emergencyPhoneNumber = data.emergencyPhoneNumber

    // Employment Info
    if (data.department !== undefined && data.department !== currentEmployee.department)
      updateData.department = data.department
    if (data.jobTitle !== undefined && data.jobTitle !== currentEmployee.jobTitle) updateData.jobTitle = data.jobTitle
    if (data.employmentType !== undefined && data.employmentType !== currentEmployee.employmentType)
    ...
    if (data.reportingManagerId !== undefined && data.reportingManagerId !== currentEmployee.reportingManagerId)
      updateData.reportingManagerId = data.reportingManagerId
    if (data.workLocation !== undefined && data.workLocation !== currentEmployee.workLocation)
      updateData.workLocation = data.workLocation
    if (data.workEmail !== undefined && data.workEmail !== currentEmployee.workEmail)
      updateData.workEmail = data.workEmail
    if (data.workPhone !== undefined && data.workPhone !== currentEmployee.workPhone)
      updateData.workPhone = data.workPhone
    if (data.employmentStatus !== undefined && data.employmentStatus !== currentEmployee.employmentStatus)
