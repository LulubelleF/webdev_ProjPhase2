  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Update user account details for {user.username}</CardDescription>
      </CardHeader>
      <CardContent>
        <form className="space-y-6" onSubmit={handleUpdateUser}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-500">User ID cannot be changed</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={editForm.roleLevel} onValueChange={(value) => handleEditFormChange("roleLevel", value)}>
                <SelectTrigger className={formErrors.roleLevel ? "border-red-500" : ""}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="status">{editForm.activeStatus ? "Active" : "Inactive"}</Label>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                <ResetPasswordDialog username={user.username} userId={user.id} />
              </div>
              <p className="text-sm text-slate-500">Use the reset button to generate a new password for this user.</p>
            </div>
          </div>
